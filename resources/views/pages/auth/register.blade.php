            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="password" type="password" class="form-control pwstrength @error('password_confirmation')
                            is-invalid
                        @enderror" data-indicator="pwindicator" name="password_confirmation">
                        <div id="pwindicator"
                            class="pwindicator">
